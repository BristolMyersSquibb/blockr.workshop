...
1. Add a `new_customdata_block` with `demo` as __selected__ dataset.
2. Add a `new_ggplot_block` with `x` as __func__ and `AGE` as __default_columns__.
3. Add a `new_geomhistogram_block`.
4. Add a `new_theme_block`.
:::
