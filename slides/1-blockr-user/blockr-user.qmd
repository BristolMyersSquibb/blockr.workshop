...
## Zoom on blocks {style="font-size: 1.5em"}

- Blocks categories: import (data), transform, plot, ...
...
- Takes input data.
- May expose __interactive__ input to transform the data.
- Returns the transformed data.
:::
::::


## Palmer penguins with blockr {style="font-size: 1.5em"}
