...
## How does a select block look like? (1/4) {auto-animate=true style="font-size: 1.5em"}
...
## How does a select block look like? (2/4) {auto-animate=true style="font-size: 1.5em"}
...
## How does a select block look like? (3/4) {auto-animate=true style="font-size: 1.5em"}
